...
class HydroSourceTerms {
 public:
  ...
  void CompanionGravity(const Real dt,const AthenaArray<Real> *flux,
                        const AthenaArray<Real> &prim,
                        AthenaArray<Real> &cons);
 ...
 private:
  ...
  bool flag_user_gravity_; // flag for calling UserGravity function
  bool flag_companion_gravity_; // flag for calling CompanionGravity function
